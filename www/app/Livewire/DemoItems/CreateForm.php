...
class CreateForm extends Component
{
    ...
    public function save(): void
    {
        ...
        app(DemoItemService::class)->create(auth()->user(), [
        ...
        if ($this->isModal) {
            $this->dispatch('demo-item-created');
            $this->reset(['title', 'description', 'status', 'priority', 'amount', 'dueDate']);
            $this->status = 'draft';
            $this->priority = 'medium';
            $this->amount = '0';
        } else {
            session()->flash('message', 'Demo item created.');
    ...
    {
        return view('livewire.demo-items.create-form', [
