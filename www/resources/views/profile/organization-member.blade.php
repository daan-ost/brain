        ...
        <section>
            @if($organization)
                <div class="space-y-6">
                    <!-- Organization Header -->
                    <div>
                        <h3 class="text-lg font-medium text-gray-900 mb-2">{{ __('profile.my_organization') }}</h3>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                <h5 class="text-sm font-medium text-gray-700 mb-2">{{ __('profile.administrators') }}:</h5>
                                <div class="space-y-2">
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                <div class="flex items-center text-sm">
                                    ...
                                    <span class="text-gray-700">
                                        {{ __('profile.team_members') }}: <span class="font-medium text-gray-900">{{ $memberCount }}</span>
                                    </span>
                                </div>
                            </div>

                            <!-- Credit Usage -->
                            @if($usesOrganizationCredits)
                                <div class="mt-4 pt-4 border-t border-gray-200">
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3">
                                                <p class="text-sm text-green-700">
                                                    {{ __('profile.organization_credits_in_use') }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
