<section id="delete-account" class="scroll-mt-32 space-y-6">
    <header>
    ...
    >{{ __('profile.delete_account_button') }}</x-danger-button>
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6">
                <x-input-label for="password" value="{{ __('profile.confirm_password') }}" class="sr-only" />
