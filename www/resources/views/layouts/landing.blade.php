{{--
    ...
    Used by: <x-landing-layout> Blade component
    Related: layouts/landing-page.blade.php (used by @extends)
...
<head>
    ...
    <!-- Title -->
    <title>{{ $pageTitle ?? __('seo.site_title') }} | {{ config('app.name') }}</title>
    ...
    <!-- Open Graph Tags -->
    <meta property="og:title" content="{{ $pageTitle ?? __('seo.site_title') }}">
    <meta property="og:description" content="{{ $pageDescription ?? __('seo.default_description') }}">
    <meta property="og:image" content="{{ $ogImage ?? asset('og-images/og-default.svg') }}">
    ...
    <meta name="twitter:title" content="{{ $pageTitle ?? __('seo.site_title') }}">
    <meta name="twitter:description" content="{{ $pageDescription ?? __('seo.default_description') }}">
    <meta name="twitter:image" content="{{ $ogImage ?? asset('og-images/og-default.svg') }}">
