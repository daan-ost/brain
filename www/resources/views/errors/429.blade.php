...
<div class="min-h-screen">
    ...
    <div class="masthead py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">429</h1>
    ...
    <section class="content-section py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                <p class="text-base leading-7 text-gray-600">Please slow down and try again in a moment.</p>
