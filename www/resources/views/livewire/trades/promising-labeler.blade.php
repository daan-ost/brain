                ...
                <div class="p-5">
                    ...
                    <div class="border-t border-slate-800 pt-4 space-y-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div class="flex flex-col">
                                <span class="text-xs text-slate-500 mb-0.5">beste sell-tijd overschrijven (op moment-datum)</span>
                            ...
                            <div class="flex flex-col">
                                <span class="text-xs text-slate-500 mb-0.5">harde verkooptijd (op moment-datum)</span>
