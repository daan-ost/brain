        ...
        <header class="bg-gradient-to-br from-[#9FD6D2] to-[#53B3AE]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-4">
                    ...
                    <a href="/pricing" class="inline-flex items-center px-5 py-2.5 bg-white bg-opacity-20 hover:bg-opacity-30 text-white rounded-lg transition-all duration-200 font-medium">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                        </svg>
                        {{ app()->getLocale() === 'nl' ? 'Terug naar Prijzen' : 'Back to Pricing' }}
                    </a>
                </div>
            </div>
        </header>
